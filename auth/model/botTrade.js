...
module.exports = {
	...
	SEND_RESULT(kq){
		...
		if(guess == kq){
			...
			if(guessWIN > 1){
				Tele.sendMessBOTTrade(`💬 Kết quả: CHIẾN THẮNG liên tục ${guessWIN} phiên.\WINVIP.TRADE bot hoàn toàn miễn phí`);
			}else if(guessWIN == 1){
				Tele.sendMessBOTTrade(`💬 Kết quả: CHIẾN THẮNG ${guessWIN} phiên.\WINVIP.TRADE bot hoàn toàn miễn phí`);
			}
